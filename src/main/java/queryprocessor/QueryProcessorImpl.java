...
public class QueryProcessorImpl implements QueryProcessor {
    ...
    private final SFTP fileTransfer = new SFTP();
    private final Log log = Log.getLogInstance();
    private final String username = Session.getInstance().getLoggedInDBUser().getUserName();
    private final String VMName = SFTP.REMOTE_HOST;
